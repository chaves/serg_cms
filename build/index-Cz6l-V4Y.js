...
`,A=he((e,t)=>{const{className:o,alignItems:r,direction:n,inline:s,gap:i,justifyContent:l,wrap:d,...u}=e,h={$alignItems:r,$direction:n,$gap:i,$justifyContent:l,$wrap:d,$inline:s};return a.jsx(jl,{className:o,ref:t,...h,...u})}),jl=b(I)`
...
`,Tl=({$variant:e=qn,theme:t})=>{switch(e){case yl:return`
      ...
      `;default:return`
        font-size: ${t.fontSizes[2]};
      `}},B=he((e,t)=>{const{ellipsis:o,textColor:r="currentcolor",textDecoration:n,textTransform:s,variant:i,lineHeight:l,fontWeight:d,fontSize:u,...h}=e,g={$ellipsis:o,$textColor:r,$textDecoration:n,$textTransform:s,$variant:i,$lineHeight:l,$fontWeight:d,$fontSize:u};return a.jsx(Vl,{ref:t,tag:"span",...g,...h})}),Vl=b(I)`
  ${Tl}
  ${({$ellipsis:e})=>e?xo:""}
...
`,[El,Rn]=Ge("Accordion"),Ll=c.forwardRef(({children:e,size:t="S",...o},r)=>a.jsx(Dl,{ref:r,$size:t,collapsible:!0,...o,type:"single",children:a.jsx(El,{size:t,children:e})})),Dl=b(Ur)`
  ...
  ${e=>e.$size==="S"?E`
      ...
      `:E``}
`,Hl=c.forwardRef((e,t)=>{const{size:o}=Rn("Item");return a.jsx(zl,{$size:o,"data-size":o,ref:t,...e})}),zl=b(qr)`
  overflow: hidden;
  margin: 1px 0;
...
`,kl=c.forwardRef((e,t)=>{const{size:o}=Rn("Trigger");return a.jsx(po,{$size:o,...e,ref:t})}),po=b(A).attrs(e=>({...e,tag:"span"}))`
...
`,Ol=c.forwardRef(({variant:e="primary",...t},o)=>a.jsx(Nl,{$variant:e,ref:o,...t})),Nl=b(Gr)`
  display: flex;
  align-items: center;
...
`,lu=Object.freeze(Object.defineProperty({__proto__:null,Actions:kl,Content:_l,Header:Ol,Item:Hl,Root:Ll,Trigger:Bl},Symbol.toStringTag,{value:"Module"})),pt=E`
  position: relative;
  outline: none;
...
`,Ke=({tag:e,...t})=>{const o=e||"span";return a.jsx(ql,{...t,as:o})},ql=b.span`
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
  ...
  position: absolute;
  width: 1px;
`,Pe=({children:e,label:t})=>{const o=c.Children.only(e);return a.jsxs(a.Fragment,{children:[c.cloneElement(o,{"aria-hidden":"true",focusable:"false"}),a.jsx(Ke,{children:t})]})};Pe.displayName="AccessibleIcon";const Wt=({theme:e,$variant:t})=>t==="danger"?e.colors.danger700:t==="success"?e.colors.success700:t==="warning"?e.colors.warning700:e.colors.primary700;b(I)`
  ${pt};
`;b(A)`
  svg {
    height: 100%;
...
`,Zl=b.img`
  ${Co}
`;c.forwardRef((e,t)=>a.jsx(Xl,{...e,ref:t,tag:"div"}));const Xl=b(A)`
  & > ${Ut} + ${Ut} {
...
`,r2=c.forwardRef(({children:e,...t},o)=>a.jsx(o2,{ref:o,...t,children:e}));r2.displayName="CrumbLink";const Fe=e=>e.replaceAll(":","");function a2(e,t){typeof e=="function"?e(t):e!=null&&(e.current=t)}function yo(...e){return t=>e.forEach(o=>a2(o,t))}function fe(...e){return c.useCallback(yo(...e),e)}const s2=()=>typeof window>"u"||!window.navigator||/ServerSideRendering|^Deno\//.test(window.navigator.userAgent),Ae=s2()?c.useEffect:c.useLayoutEffect,i2=kr.useId||(()=>{});let c2=0;const $e=e=>{const[t,o]=c.useState(i2());return Ae(()=>{e||o(r=>r??String(c2++))},[e]),e?.toString()??(t||"")},at=(e,t,{selectorToWatch:o,skipWhen:r=!1})=>{const n=an(t);c.useEffect(()=>{if(r||!e.current)return;const s={root:e.current,rootMargin:"0px"},i=u=>{u.forEach(h=>{h.isIntersecting&&e.current&&e.current.scrollHeight>e.current.clientHeight&&n(h)})},l=new IntersectionObserver(i,s),d=e.current.querySelector(o);return d&&l.observe(d),()=>{l.disconnect()}},[r,n,o,e])},Mn="success-light",An="danger-light",bt="default",st="tertiary",it="secondary",So="danger",Ro="success",$t="ghost",In=[Mn,An],l2=[bt,st,it,So,Ro,$t,...In],d2=["XS","S","M","L"],ve=e=>e===Mn||e===An?`${e.substring(0,e.lastIndexOf("-"))}`:e===st?"neutral":e===bt||e===it||l2.every(t=>t!==e)?"primary":`${e}`,Mo=({theme:e})=>E`
  ...
  `,To=({theme:e,$variant:t})=>{switch(t){case An:case Mn:case it:return E`
      ...
      `}},qt=he(({variant:e=bt,startIcon:t,endIcon:o,disabled:r=!1,children:n,onClick:s,size:i=d2[1],loading:l=!1,fullWidth:d=!1,type:u="button",...h},g)=>{const f=r||l,x=C=>{!f&&s&&s(C)},w=h.tag??"button",p=w==="button"||w==="input"?u:void 0;return a.jsxs(f2,{ref:g,"aria-disabled":f,disabled:f,$size:i,$variant:e,tag:"button",onClick:x,hasRadius:!0,gap:2,inline:!0,alignItems:"center",justifyContent:"center",width:d?"100%":void 0,paddingLeft:4,paddingRight:4,cursor:"pointer",type:p,...h,children:[(t||l)&&a.jsx(A,{tag:"span","aria-hidden":!0,children:l?a.jsx(u2,{}):t}),a.jsx(B,{variant:i==="S"?"pi":void 0,fontWeight:"bold",children:n}),o&&a.jsx(A,{tag:"span","aria-hidden":!0,children:o})]})}),h2=le`
  from {
...
`,Vo=c.forwardRef(({children:e,description:t,label:o,defaultOpen:r,open:n,onOpenChange:s,delayDuration:i=500,disableHoverableContent:l,...d},u)=>!o&&!t?e:a.jsxs(C0,{defaultOpen:r,open:n,onOpenChange:s,delayDuration:i,disableHoverableContent:l,children:[a.jsx(j0,{asChild:!0,children:e}),a.jsx(y0,{children:a.jsx(g2,{ref:u,sideOffset:8,...d,children:a.jsx(B,{variant:"pi",fontWeight:"bold",children:o||t})})})]})),g2=b(S0)`
...
`;const m2=he(({children:e,href:t,disabled:o=!1,startIcon:r,endIcon:n,isExternal:s=!1,color:i="primary600",activeColor:l="primary700",...d},u)=>a.jsxs(x2,{ref:u,href:t,disabled:o,isExternal:s,$activeColor:l,$color:i,...d,children:[r,a.jsx(B,{textColor:o?"neutral600":i,children:e}),n,t&&!n&&s&&a.jsx(ri,{fill:i})]})),x2=b(rt)`
  display: inline-flex;
  align-items: center;
  text-decoration: none;
  ...
  ${pt};
`,w2=e=>{switch(e){case"danger":return"danger100";default:return"primary100"}},v2=(e,t)=>{switch(e){case"danger":return"danger700";default:return"neutral800"}},Tt=(e,t)=>{switch(e){case"danger":return t?"danger500":"danger700";default:return t?"neutral300":"neutral500"}},p2=a1,b2=c.forwardRef(({label:e,endIcon:t=a.jsx(He,{width:"1.2rem",height:"1.2rem","aria-hidden":!0}),tag:o=qt,icon:r,...n},s)=>{const i={...n,ref:s,type:"button"};return a.jsx(Pr,{asChild:!0,disabled:i.disabled,children:o===ze?a.jsx(ze,{label:e,variant:"tertiary",...i,children:r}):a.jsx(qt,{endIcon:t,variant:"ghost",...i})})}),$2=c.forwardRef(({children:e,intersectionId:t,onCloseAutoFocus:o,popoverPlacement:r="bottom-start",...n},s)=>{const[i,l]=r.split("-");return a.jsx(M0,{children:a.jsx(C2,{align:l,side:i,loop:!0,onCloseAutoFocus:o,asChild:!0,children:a.jsxs(Eo,{ref:s,direction:"column",borderColor:"neutral150",hasRadius:!0,background:"neutral0",shadow:"filterShadow",maxHeight:"15rem",padding:1,marginTop:1,marginBottom:1,alignItems:"flex-start",position:"relative",overflow:"auto",...n,children:[e,a.jsx(I,{id:t,width:"100%",height:"1px"})]})})})}),Eo=b(A)`
...
`;c.forwardRef((e,t)=>a.jsx(t1,{...e,asChild:!0,children:a.jsx(y2,{height:"1px",shrink:0,background:"neutral150",ref:t})}));c.forwardRef((e,t)=>a.jsx(n1,{asChild:!0,children:a.jsx(S2,{ref:t,variant:"sigma",textColor:"neutral600",...e})}));const S2=b(B)`
  padding: ${({theme:e})=>e.spaces[2]} ${({theme:e})=>e.spaces[4]};
`;c.forwardRef(({disabled:e=!1,...t},o)=>a.jsx(o1,{asChild:!0,disabled:e,children:a.jsxs(R2,{ref:o,color:"neutral800",tag:"button",type:"button",background:"transparent",borderStyle:"none",gap:5,...t,children:[a.jsx(B,{children:t.children}),a.jsx(Sn,{fill:"neutral500",height:"1.2rem",width:"1.2rem"})]})}));const R2=b(j2)`
  &[data-state='open'] {
    background-color: ${({theme:e})=>e.colors.primary100};
  }
`;c.forwardRef((e,t)=>a.jsx(M0,{children:a.jsx(r1,{sideOffset:8,asChild:!0,children:a.jsx(Eo,{ref:t,direction:"column",borderStyle:"solid",borderWidth:"1px",borderColor:"neutral150",hasRadius:!0,background:"neutral0",shadow:"filterShadow",maxHeight:"15rem",padding:1,alignItems:"flex-start",overflow:"auto",...e})})}));const M2=p2,A2=b2,I2=$2,T2=c.forwardRef(({children:e,onOpen:t,onClose:o,popoverPlacement:r,onReachEnd:n,...s},i)=>{const l=c.useRef(null),d=fe(i,l),u=c.useRef(null),[h,g]=c.useState(!1),f=C=>{n&&n(C)},x=C=>{C&&typeof t=="function"?t():!C&&typeof o=="function"&&o(),g(C)},w=$e(),p=`intersection-${Fe(w)}`;return at(u,f,{selectorToWatch:`#${p}`,skipWhen:!h}),a.jsxs(M2,{onOpenChange:x,children:[a.jsx(A2,{ref:d,...s,children:s.label}),a.jsx(I2,{ref:u,intersectionId:p,popoverPlacement:r,children:e})]})}),V2=b(T2)`
  padding: ${({theme:e})=>`${e.spaces[1]} ${e.spaces[2]}`};
  height: unset;
...
`,Tn=c.forwardRef(({children:e,...t},o)=>{const r=$e(t.id);return e?a.jsxs(A,{gap:2,children:[a.jsx(Zn,{id:r,...t}),a.jsx(B,{tag:"label",textColor:"neutral800",htmlFor:r,children:e})]}):a.jsx(Zn,{ref:o,...t})});c.forwardRef((e,t)=>{const{id:o}=L2();return a.jsx(D2,{position:"start",children:a.jsx(Tn,{"aria-labelledby":`${o}-title`,...e,ref:t})})});b(I)`
  word-break: break-all;
`;b(A)`
  border-bottom: 1px solid ${({theme:e})=>e.colors.neutral150};
`;const de={DOWN:"ArrowDown",UP:"ArrowUp",RIGHT:"ArrowRight",LEFT:"ArrowLeft",ESCAPE:"Escape",ENTER:"Enter",END:"End",HOME:"Home",PAGE_UP:"PageUp",PAGE_DOWN:"PageDown"},O2=b(I)`
...
`,K2=b(A)`
  ...
  ${({theme:e,$disabled:t})=>t?E`
          ...
          background: ${e.colors.neutral150};
        `:void 0};
`,Ho=()=>{const{id:e,hint:t,error:o}=ge("Hint");return!t||o?null:a.jsx(B,{variant:"pi",tag:"p",id:`${e}-hint`,textColor:"neutral600",children:t})},zo=()=>{const{id:e,error:t}=ge("Error");return!t||typeof t!="string"?null:a.jsx(B,{variant:"pi",tag:"p",id:`${e}-error`,textColor:"danger600","data-strapi-field-error":!0,children:t})},Y2=c.forwardRef(({label:e,children:t,...o},r)=>a.jsx(Z2,{justifyContent:"unset",background:"transparent",borderStyle:"none",...o,type:"button",tag:"button",ref:r,children:a.jsx(Pe,{label:e,children:t})})),Z2=b(A)`
  font-size: 1.6rem;
  padding: 0;
`,du=Object.freeze(Object.defineProperty({__proto__:null,Action:Y2,Error:zo,Hint:Ho,Input:Ct,Label:Vn,Root:Be,useField:ge},Symbol.toStringTag,{value:"Module"}));c.forwardRef(({actions:e,children:t,error:o,hint:r,label:n,labelAction:s,nextLabel:i,onNext:l,onPrevious:d,previousLabel:u,required:h,secondaryLabel:g,selectedSlide:f,id:x,...w},p)=>{const C=$e(x);return a.jsx(Be,{hint:r,error:o,id:C,required:h,children:a.jsxs(A,{direction:"column",alignItems:"stretch",gap:1,children:[n&&a.jsx(Vn,{action:s,children:n}),a.jsx(_2,{ref:p,actions:e,label:n,nextLabel:i,onNext:l,onPrevious:d,previousLabel:u,secondaryLabel:g,selectedSlide:f,id:C,...w,children:t}),a.jsx(Ho,{}),a.jsx(zo,{})]})})});b(I)`
  ${xo}
`;b(A)`
  display: ${({$selected:e})=>e?"flex":"none"};
`;const jt=c.forwardRef(({children:e,viewportRef:t,...o},r)=>a.jsxs(X2,{ref:r,...o,children:[a.jsx(Q2,{ref:t,children:e}),a.jsx(Qn,{orientation:"vertical",children:a.jsx(Jn,{})}),a.jsx(Qn,{orientation:"horizontal",children:a.jsx(Jn,{})})]})),X2=b(Or)`
  width: 100%;
  height: 100%;
  overflow: hidden;
  display: flex;
...
`,hu=Object.freeze(Object.defineProperty({__proto__:null,Item:xd,Root:gd},Symbol.toStringTag,{value:"Module"})),vd=({children:e,estimatedItemSize:t=40,overscan:o=10,itemCount:r,renderItem:n})=>{const s=c.useRef(null),[i,l]=c.useState(!1),d=c.useRef(!0);c.useEffect(()=>(d.current=!0,typeof c.startTransition=="function"&&c.startTransition(()=>{d.current&&l(!0)}),()=>{d.current=!1}),[]);const u=c.useMemo(()=>n&&r!==void 0?[]:c.Children.toArray(e),[e,n,r]),h=r??u.length,g=fd({count:h,getScrollElement:()=>s.current??null,estimateSize:c.useCallback(()=>t,[t]),overscan:o,scrollMargin:0,measureElement:void 0,lanes:1}),f=i&&d.current?g.getVirtualItems():[];return i?a.jsx(I,{ref:s,height:`${g.getTotalSize()>0?g.getTotalSize():0}px`,width:"100%",position:"relative","data-testid":"virtualized-list",style:{willChange:"transform"},children:f.map(x=>{const w=n?n(x.index):u[x.index];return a.jsx(I,{"data-index":x.index,style:{position:"absolute",top:0,left:0,width:"100%",transform:`translate3d(0, ${x.start}px, 0)`},children:w},x.key)})}):a.jsx(I,{ref:s,height:"40px",width:"100%",position:"relative"})},pd=c.forwardRef(({allowCustomValue:e,autocomplete:t,children:o,className:r,clearLabel:n="Clear",creatable:s=!1,creatableDisabled:i=!1,creatableStartIcon:l,createMessage:d=_=>`Create "${_}"`,defaultFilterValue:u,defaultTextValue:h,defaultOpen:g=!1,open:f,onOpenChange:x,disabled:w=!1,hasError:p,id:C,filterValue:$,hasMoreItems:v=!1,isPrintableCharacter:R,loading:y=!1,loadingMessage:M="Loading content...",name:j,noOptionsMessage:S=()=>"No results found",onChange:V,onClear:z,onCreateOption:L,onFilterValueChange:q,onInputChange:D,onTextValueChange:k,onLoadMore:O,placeholder:Y="Select or enter a value",required:P=!1,size:H="M",startIcon:N,textValue:G,value:J,...Z},ie)=>{const[_,se]=Ce({prop:f,defaultProp:g,onChange:x}),[ne,ue]=Ce({prop:G,defaultProp:e&&!h?J:h,onChange:k}),[T,F]=Ce({prop:$,defaultProp:u,onChange:q}),ee=c.useRef(null),W=c.useRef(null),U=fe(W,ie),K=c.useRef(null),ce=me=>{z&&!w&&(ue(""),F(""),z(me),W.current.focus())},X=me=>{se(me)},Q=me=>{ue(me)},we=me=>{F(me)},ye=me=>{D&&D(me)},lr=me=>{V&&V(me)},dr=me=>{O&&v&&!y&&O(me)},Bn=()=>{L&&ne&&s!=="visible"?L(ne):L&&s==="visible"&&(L(),se(!1))},hr=$e(),kn=`intersection-${Fe(hr)}`;at(ee,dr,{selectorToWatch:`#${kn}`,skipWhen:!_});const{error:St,...lt}=ge("Combobox"),ur=!!St||p,Rt=lt.id??C,fr=lt.name??j,gr=lt.required||P,On=c.Children.toArray(o).filter(Boolean).length,mr=!!!(ne&&ne!==""||T&&T!=="")&&On>100;let Mt;return St?Mt=`${Rt}-error`:lt.hint&&(Mt=`${Rt}-hint`),a.jsxs(pe.Root,{autocomplete:t||(s===!0?"list":"both"),onOpenChange:X,open:_,onTextValueChange:Q,textValue:ne,allowCustomValue:!!s||e,disabled:w,required:gr,value:J,onValueChange:lr,filterValue:T,onFilterValueChange:we,isPrintableCharacter:R,visible:s==="visible",children:[a.jsxs(bd,{$hasError:ur,$size:H,className:r,children:[a.jsxs(A,{flex:"1",tag:"span",gap:3,children:[N?a.jsx(A,{flex:"0 0 1.6rem",tag:"span","aria-hidden":!0,children:N}):null,a.jsx($d,{placeholder:Y,id:Rt,"aria-invalid":!!St,onChange:ye,ref:U,name:fr,"aria-describedby":Mt,...Z})]}),a.jsxs(A,{tag:"span",gap:3,children:[ne&&z?a.jsx(ze,{size:"XS",variant:"ghost",onClick:ce,"aria-disabled":w,"aria-label":n,label:n,ref:K,children:a.jsx(qe,{})}):null,a.jsx(Cd,{children:a.jsx(He,{fill:"neutral500"})})]})]}),a.jsx(pe.Portal,{children:a.jsx(jd,{sideOffset:4,children:a.jsxs(pe.Viewport,{ref:ee,children:[a.jsxs(Sd,{children:[mr?a.jsx(vd,{itemCount:On,children:o}):o,s!==!0&&!y?a.jsx(pe.NoValueFound,{asChild:!0,children:a.jsx(Gt,{$hasHover:!1,children:a.jsx(B,{children:S(ne??"")})})}):null,y?a.jsx(A,{justifyContent:"center",alignItems:"center",paddingTop:2,paddingBottom:2,children:a.jsx(P2,{small:!0,children:M})}):null,a.jsx(I,{id:kn,width:"100%",height:"1px"})]}),s?a.jsx(yd,{onPointerUp:Bn,onClick:Bn,disabled:i,asChild:!0,children:a.jsx(Gt,{children:a.jsxs(A,{gap:2,children:[l&&a.jsx(I,{tag:"span","aria-hidden":!0,display:"inline-flex",children:l}),a.jsx(B,{children:d(ne??"")})]})})}):null]})})})]})}),bd=b(pe.Trigger)`
  position: relative;
  border: 1px solid ${({theme:e,$hasError:t})=>t?e.colors.danger600:e.colors.neutral200};
  border-radius: ${({theme:e})=>e.borderRadius};
  background: ${({theme:e})=>e.colors.neutral0};
...
`,Sd=b(jt)`
  padding: ${({theme:e})=>e.spaces[1]};
`,Rd=c.forwardRef(({children:e,value:t,disabled:o,textValue:r,...n},s)=>a.jsx(pe.ComboboxItem,{asChild:!0,value:t,disabled:o,textValue:r,children:a.jsx(Gt,{ref:s,...n,children:a.jsx(pe.ItemText,{asChild:!0,children:a.jsx(B,{children:e})})})})),Gt=b.div`
  width: 100%;
  border: none;
  text-align: left;
  outline-offset: -3px;
...
`,ko=(e,t)=>`${e}${Math.floor(t*255).toString(16).padStart(2,"0")}`,Md=jr,Ad=c.forwardRef((e,t)=>a.jsx(Ar,{...e,asChild:!0,ref:t})),Id=c.forwardRef((e,t)=>a.jsx(Vr,{children:a.jsx(Td,{children:a.jsx(Vd,{ref:t,...e})})})),Td=b(zr)`
...
`,Ed=c.forwardRef(({children:e,...t},o)=>a.jsx(Ir,{asChild:!0,children:a.jsx(Ld,{tag:"h2",variant:"beta",ref:o,padding:6,fontWeight:"bold",...t,children:e})})),Ld=b(B)`
  display: flex;
  justify-content: center;
  border-bottom: solid 1px ${e=>e.theme.colors.neutral150};
`,Dd=c.forwardRef(({children:e,icon:t,...o},r)=>a.jsx(A,{ref:r,gap:2,direction:"column",paddingTop:8,paddingBottom:8,paddingLeft:6,paddingRight:6,...o,children:typeof e=="string"?a.jsxs(a.Fragment,{children:[t?c.cloneElement(t,{width:24,height:24}):null,a.jsx(Oo,{children:e})]}):e})),Oo=c.forwardRef((e,t)=>a.jsx(Tr,{asChild:!0,children:a.jsx(B,{ref:t,variant:"omega",...e,tag:"p"})})),Hd=c.forwardRef((e,t)=>a.jsx(zd,{ref:t,gap:2,padding:4,justifyContent:"space-between",...e,tag:"footer"})),zd=b(A)`
...
`}
`;const i0="en-EN",Nd=()=>typeof navigator>"u"?i0:navigator.language?navigator.language:i0,[gu,yt]=Ge("StrapiDesignSystem",{locale:Nd()}),_d=u1,No=c.forwardRef(({container:e=globalThis?.document?.body,...t},o)=>e?We.createPortal(a.jsx(I,{ref:o,...t}),e):null);No.displayName="Portal";const Fd=c.forwardRef(({onClear:e,clearLabel:t="Clear",startIcon:o,disabled:r,hasError:n,children:s,id:i,size:l="M",withTags:d,...u},h)=>{const g=c.useRef(null),f=p=>{e&&!r&&(e(p),g.current.focus())},{labelNode:x}=ge("SelectTrigger"),w=fe(g,h);return a.jsx(be.Trigger,{asChild:!0,children:a.jsxs(Wd,{"aria-disabled":r,$hasError:n,ref:w,alignItems:"center",justifyContent:"space-between",position:"relative",overflow:"hidden",hasRadius:!0,background:r?"neutral150":"neutral0",gap:4,cursor:"default","aria-labelledby":x?`${i}-label`:void 0,$size:l,$withTags:d,...u,children:[a.jsxs(A,{flex:"1",tag:"span",gap:3,children:[o&&a.jsx(A,{tag:"span","aria-hidden":!0,children:o}),s]}),a.jsxs(A,{tag:"span",gap:3,children:[e?a.jsx(ze,{size:"XS",variant:"ghost",onClick:f,"aria-disabled":r,"aria-label":t,label:t,children:a.jsx(qe,{})}):null,a.jsx(Ud,{children:a.jsx(He,{})})]})]})})}),Wd=b(A)`
  border: 1px solid ${({theme:e,$hasError:t})=>t?e.colors.danger600:e.colors.neutral200};
  ${e=>{switch(e.$size){case"S":return E`
          padding-block: ${e.theme.spaces[1]};
...
`,qd=c.forwardRef(({children:e,placeholder:t,...o},r)=>a.jsx(Gd,{ref:r,ellipsis:!0,...o,children:a.jsx(Kd,{placeholder:t,children:e})})),Gd=b(B)`
  flex: 1;
  font-size: 1.4rem;
  line-height: 2.2rem;
  min-height: 2.2rem;
`,Kd=b(be.Value)`
  ...
  flex-wrap: wrap;
`,Yd=c.forwardRef((e,t)=>a.jsx(Zd,{ref:t,...e,children:a.jsx(jt,{children:e.children})})),Zd=b(be.Content)`
  background: ${({theme:e})=>e.colors.neutral0};
  box-shadow: ${({theme:e})=>e.shadows.filterShadow};
  border: 1px solid ${({theme:e})=>e.colors.neutral150};
  border-radius: ${({theme:e})=>e.borderRadius};
...
`,_o=be.Root,Fo=Fd,Wo=qd,Uo=be.Portal,qo=Yd,Go=Xd,Ln=Qd,Ko=be.ItemIndicator,Yo=be.ItemText,e5=be.Group,c0=c.forwardRef(({children:e,clearLabel:t="Clear",customizeContent:o,disabled:r,hasError:n,id:s,name:i,onChange:l,onClear:d,onCloseAutoFocus:u,onReachEnd:h,placeholder:g,required:f,size:x,startIcon:w,value:p,...C},$)=>{const[v,R]=c.useState(),[y,M]=c.useState(!1),j=Z=>{M(Z)},S=Z=>{d&&d(Z),l||R("")},V=Z=>{l?l(typeof p=="number"?Number(Z):Z):R(Z)},z=c.useRef(null),L=$e(),q=`intersection-${Fe(L)}`;at(z,Z=>{h&&h(Z)},{selectorToWatch:`#${q}`,skipWhen:!y});const{error:k,required:O,...Y}=ge("SingleSelect"),P=!!k||n,H=Y.id??s,N=Y.name??i;let G;k?G=`${H}-error`:Y.hint&&(G=`${H}-hint`);const J=(typeof p<"u"&&p!==null?p.toString():v)??"";return a.jsxs(_o,{onOpenChange:j,disabled:r,required:O??f,onValueChange:V,value:J,...C,children:[a.jsx(Fo,{ref:$,id:H,name:N,startIcon:w,hasError:P,disabled:r,clearLabel:t,onClear:J&&d?S:void 0,"aria-label":C["aria-label"],"aria-describedby":G??C["aria-describedby"],size:x,children:a.jsx(Wo,{placeholder:g,textColor:J?"neutral800":"neutral600",children:J&&o?o(J):void 0})}),a.jsx(Uo,{children:a.jsx(qo,{position:"popper",sideOffset:4,onCloseAutoFocus:u,children:a.jsxs(Go,{ref:z,children:[e,a.jsx(I,{id:q,width:"100%",height:"1px"})]})})})]})}),l0=c.forwardRef(({value:e,startIcon:t,children:o,...r},n)=>a.jsxs(Ln,{ref:n,value:e.toString(),...r,children:[t&&a.jsx(A,{tag:"span","aria-hidden":!0,children:t}),a.jsx(B,{lineHeight:"20px",width:"100%",children:a.jsx(Yo,{children:o})})]})),t5=200,d0=15,[n5,Ye]=Ge("DatePicker"),o5=c.forwardRef(({calendarLabel:e,className:t,initialDate:o,locale:r,maxDate:n,minDate:s,monthSelectLabel:i="Month",onChange:l,value:d,yearSelectLabel:u="Year",hasError:h,id:g,name:f,disabled:x=!1,required:w=!1,onClear:p,clearLabel:C="Clear",size:$="M",...v},R)=>{const y=Dt(),M=yt("DatePicker"),j=r??M.locale,S=Re(j,{day:"2-digit",month:"2-digit",year:"numeric"}),[V,z]=c.useState(!1),[L,q]=c.useState(null),[D,k]=c.useState(null),[O,Y]=c.useState(null),[P,H]=c.useState(),[N,G]=Ce({defaultProp:o?Ve(o):void 0,prop:d?Ve(d):void 0,onChange(Q){l&&l(Q?.toDate(y))}}),[J,Z]=c.useMemo(()=>{const Q=o?Ve(o):Pt("UTC"),we=s?Ve(s):Q.set({day:1,month:1,year:Q.year-t5});let ye=n?Ve(n):Q.set({day:31,month:12,year:Q.year+d0});return ye.compare(we)<0&&(ye=we.set({day:31,month:12,year:we.year+d0})),[we,ye]},[s,n,o]),[ie,_]=c.useState(r5({currentValue:N,minDate:J,maxDate:Z})),se=$e(),ne=c.useRef(null),ue=Q=>{p&&!x&&(H(""),G(void 0),p(Q),D?.focus())},T=c.useCallback(Q=>{Q&&N&&_(N),z(Q)},[N]);Ae(()=>{if(d){const Q=Ve(d);H(S.format(Q.toDate(y))),_(Q)}else H("")},[d,S,y]),Ae(()=>{if(o&&P===void 0){const Q=Ve(o);H(S.format(Q.toDate(y)))}},[o,P,S,y]);const{error:F,...ee}=ge("Combobox"),W=!!F||h,U=ee.id??g,K=ee.name??f,ce=ee.required||w;let X;return F?X=`${U}-error`:ee.hint&&(X=`${U}-hint`),a.jsxs(n5,{calendarDate:ie,content:O,contentId:se,disabled:x,locale:j,minDate:J,maxDate:Z,open:V,onCalendarDateChange:_,onContentChange:Y,onOpenChange:T,onTextInputChange:k,onTextValueChange:H,onTriggerChange:q,onValueChange:G,onClear:p,required:ce,textInput:D,textValue:P,timeZone:y,trigger:L,value:N,children:[a.jsxs(s5,{className:t,hasError:W,size:$,children:[a.jsx(ms,{fill:"neutral500","aria-hidden":!0}),a.jsx(l5,{ref:R,"aria-describedby":X,id:U,name:K,...v}),P&&p?a.jsx(ze,{size:"XS",variant:"ghost",onClick:ue,"aria-disabled":x,"aria-label":C,label:C,ref:ne,children:a.jsx(qe,{})}):null]}),a.jsx(No,{children:a.jsx(f5,{label:e,children:a.jsx(b5,{monthSelectLabel:i,yearSelectLabel:u})})})]})}),h0=e=>!!e.match(/^[^a-zA-Z]*$/),r5=({currentValue:e,minDate:t,maxDate:o})=>{const r=Pt("UTC");return e||(Ht(t,r)===t&&zt(o,r)===o?r:Ht(t,r)===r?t:zt(o,r)===r?o:r)},a5="DatePickerTrigger",s5=c.forwardRef(({hasError:e,size:t,...o},r)=>{const n=Ye(a5),s=fe(r,l=>n.onTriggerChange(l)),i=()=>{n.disabled||n.onOpenChange(!0)};return a.jsx(Xt,{asChild:!0,trapped:n.open,onMountAutoFocus:l=>{l.preventDefault()},onUnmountAutoFocus:l=>{document.getSelection()?.empty(),l.preventDefault()},children:a.jsx(i5,{ref:s,$hasError:e,$size:t,$hasOnClear:!!n.onClear,...o,hasRadius:!0,gap:3,overflow:"hidden",background:n.disabled?"neutral150":"neutral0",onClick:Ee(o.onClick,()=>{n.textInput?.focus()}),onPointerDown:Ee(o.onPointerDown,l=>{const d=l.target;d.hasPointerCapture(l.pointerId)&&d.releasePointerCapture(l.pointerId),(d.closest("button")??d.closest("div"))===l.currentTarget&&l.button===0&&l.ctrlKey===!1&&(i(),n.textInput?.focus())})})})}),i5=b(A)`
...
`,w5="DatePickerCalendar",[v5,p5]=Ge("DateFormatters"),b5=c.forwardRef(({monthSelectLabel:e,yearSelectLabel:t,...o},r)=>{const{locale:n,timeZone:s,minDate:i,maxDate:l,calendarDate:d,onCalendarDateChange:u}=Ye(w5),h=f1(d),g=c.useMemo(()=>{const j=i.year,S=l.year;return[...Array(S-j+1).keys()].map(V=>(j+V).toString())},[i,l]),f=Re(n,{month:"long"}),x=c.useMemo(()=>[...Array(d.calendar.getMonthsInYear(d)).keys()].map(j=>f.format(d.set({month:j+1}).toDate(s))),[d,f,s]),w=Re(n,{weekday:"short"}),p=c.useMemo(()=>{const j=A0(Pt(s),n);return[...new Array(7).keys()].map(S=>{const z=j.add({days:S}).toDate(s);return w.format(z)})},[s,n,w]),C=Re(n,{weekday:"long",day:"numeric",month:"long",year:"numeric"}),$=Re(n,{day:"numeric",calendar:d.calendar.identifier}),v=Re(n,{day:"2-digit",month:"2-digit",year:"numeric"}),R=j=>{if(typeof j=="number")return;const S=d.set({month:x.indexOf(j)+1});u(S)},y=j=>{if(typeof j=="number")return;const S=d.set({year:parseInt(j,10)});u(S)},M=$5(h,n);return a.jsx(v5,{dateFormatter:C,cellDateFormatter:$,textValueFormatter:v,children:a.jsxs(A,{ref:r,direction:"column",alignItems:"stretch",padding:4,...o,children:[a.jsxs(C5,{justifyContent:"flex-start",paddingBottom:4,paddingLeft:2,paddingRight:2,gap:2,children:[a.jsx(Be,{children:a.jsx(c0,{"aria-label":e,value:x[d.month-1],onChange:R,children:x.map(j=>a.jsx(l0,{value:j,children:j},j))})}),a.jsx(Be,{children:a.jsx(c0,{value:d.year.toString(),"aria-label":t,onChange:y,children:g.map(j=>a.jsx(l0,{value:j,children:j},j))})})]}),a.jsxs("table",{role:"grid",children:[a.jsx("thead",{"aria-hidden":!0,children:a.jsx("tr",{"aria-rowindex":0,children:p.map((j,S)=>a.jsx(j5,{"aria-colindex":S,children:j},j))})}),a.jsx("tbody",{children:[...new Array(6).keys()].map(j=>a.jsx("tr",{"aria-rowindex":j+2,children:M(j).map((S,V)=>S?a.jsx(R5,{"aria-colindex":V+1,date:S,startDate:h,disabled:i.compare(S)>0||S.compare(l)>0},S.toString()):a.jsx(Zo,{"aria-colindex":V+1},V+1))},j))})]})]})})}),$5=(e,t)=>o=>{let r=e.add({weeks:o});const n=[];r=A0(r,t);const s=g1(r,t);for(let i=0;i<s;i++)n.push(null);for(;n.length<7;){n.push(r);const i=r.add({days:1});if(I0(r,i))break;r=i}for(;n.length<7;)n.push(null);return n},C5=b(A)`
  div[role='combobox'] {
    border: 1px solid transparent;
    background: transparent;
...
`,j5=c.forwardRef(({children:e,...t},o)=>a.jsx(y5,{tag:"th",role:"gridcell",ref:o,...t,height:"2.4rem",width:"3.2rem",children:a.jsx(B,{variant:"pi",fontWeight:"bold",color:"neutral800",children:e.slice(0,2)})})),y5=b(I)`
  border-radius: ${({theme:e})=>e.borderRadius};
  text-transform: capitalize;
`,S5="DatePickerCalendarCell",R5=c.forwardRef(({date:e,startDate:t,disabled:o,...r},n)=>{const{timeZone:s,calendarDate:i,onValueChange:l,onOpenChange:d,onTextValueChange:u,onCalendarDateChange:h}=Ye(S5),{dateFormatter:g,cellDateFormatter:f,textValueFormatter:x}=p5("DatePickerCalendarCell"),w=I0(i,e),p=c.useMemo(()=>g.format(e.toDate(s)),[g,e,s]),C=c.useMemo(()=>f.formatToParts(e.toDate(s)).find(y=>y.type==="day").value,[f,e,s]),$=m1(t),v=e.compare(t)<0||e.compare($)>0;let R="neutral900";return w?R="primary600":v&&(R="neutral600"),a.jsx(Zo,{tag:"td",role:"gridcell",ref:n,"aria-selected":w,...r,hasRadius:!0,"aria-label":p,tabIndex:w?0:-1,background:w?"primary100":"neutral0",cursor:"pointer",onPointerDown:Ee(r.onPointerDown,y=>{y.preventDefault(),h(e),l(e),u(x.format(e.toDate(s))),d(!1)}),"aria-disabled":o,children:a.jsx(B,{variant:"pi",textColor:R,children:C})})}),Zo=b(I)`
  text-align: center;
  padding: 0.7rem;
...
`,xu=he(({disabled:e,...t},o)=>a.jsx(qt,{ref:o,tag:rt,tabIndex:e?-1:void 0,disabled:e,...t}));b(I)`
...
`;const B5=Cr,k5=c.forwardRef((e,t)=>a.jsx(yr,{...e,asChild:!0,ref:t})),O5=c.forwardRef((e,t)=>a.jsx(Rr,{children:a.jsx(N5,{children:a.jsx(_5,{ref:t,...e})})})),N5=b(Dr)`
  background: ${e=>ko(e.theme.colors.neutral800,.2)};
  position: fixed;
  inset: 0;
  z-index: ${e=>e.theme.zIndices.overlay};
...
`,Jo=c.forwardRef((e,t)=>a.jsx(Mr,{...e,asChild:!0,ref:t})),F5=c.forwardRef(({children:e,closeLabel:t="Close modal",...o},r)=>a.jsxs(W5,{ref:r,padding:4,paddingLeft:5,paddingRight:5,background:"neutral100",justifyContent:"space-between",...o,tag:"header",children:[e,a.jsx(Jo,{children:a.jsx(ze,{withTooltip:!1,label:t,children:a.jsx(qe,{})})})]})),W5=b(A)`
  border-bottom: solid 1px ${e=>e.theme.colors.neutral150};
`,U5=c.forwardRef((e,t)=>a.jsx(Sr,{asChild:!0,children:a.jsx(B,{tag:"h2",variant:"omega",fontWeight:"bold",ref:t,...e})})),q5=c.forwardRef(({children:e,...t},o)=>a.jsx(G5,{ref:o,...t,children:e})),G5=b(jt)`
...
`;function X5({prop:e,defaultProp:t,onChange:o=()=>{}}){const[r,n]=bo({defaultProp:t,onChange:o}),s=e!==void 0,i=e instanceof Function?e(r):e,l=s?i:r,d=an(o),u=c.useCallback(h=>{if(s){const f=typeof h=="function"?h(i):h;f!==i&&(d(f),n(h))}else n(h)},[s,i,n,d]);return[l,u]}const Q5=c.createContext({activePage:1,pageCount:1}),Dn=()=>c.useContext(Q5);he(({children:e,...t},o)=>{const{activePage:r}=Dn(),n=r===1;return a.jsxs(er,{ref:o,"aria-disabled":n,tabIndex:n?-1:void 0,...t,children:[a.jsx(Ke,{children:e}),a.jsx(go,{"aria-hidden":!0})]})});he(({children:e,...t},o)=>{const{activePage:r,pageCount:n}=Dn(),s=r===n;return a.jsxs(er,{ref:o,"aria-disabled":s,tabIndex:s?-1:void 0,...t,children:[a.jsx(Ke,{children:e}),a.jsx(Sn,{"aria-hidden":!0})]})});const Po=b(rt)`
...
`,er=b(Po)`
  ...
  pointer-events: none;
    `:void 0}
`;he(({number:e,children:t,...o},r)=>{const{activePage:n}=Dn(),s=n===e;return a.jsxs(J5,{ref:r,...o,"aria-current":s,$active:s,children:[a.jsx(Ke,{children:t}),a.jsx(B,{"aria-hidden":!0,fontWeight:s?"bold":void 0,lineHeight:"revert",variant:"pi",children:e})]})});const J5=b(Po)`
...
`;c.forwardRef((e,t)=>a.jsx(R1,{...e,asChild:!0,ref:t}));c.forwardRef((e,t)=>a.jsx(M1,{children:a.jsx(P5,{sideOffset:4,side:"bottom",align:"start",...e,ref:t})}));const P5=b(A1)`
  box-shadow: ${({theme:e})=>e.shadows.filterShadow};
  z-index: ${({theme:e})=>e.zIndices.popover};
  background-color: ${e=>e.theme.colors.neutral0};
  border: 1px solid ${({theme:e})=>e.colors.neutral150};
...
`;c.forwardRef(({children:e,intersectionId:t,onReachEnd:o,...r},n)=>{const s=c.useRef(null),i=fe(s,n),l=$e();return at(s,o??(()=>{}),{selectorToWatch:`#${Fe(l)}`,skipWhen:!t||!o}),a.jsxs(eh,{ref:i,...r,children:[e,t&&o&&a.jsx(I,{id:Fe(l),width:"100%",height:"1px"})]})});const eh=b(jt)`
  height: 20rem;
`;c.forwardRef(({size:e="M",value:t,...o},r)=>a.jsx(th,{ref:r,$size:e,...o,children:a.jsx(nh,{style:{transform:`translate3D(-${100-(t??0)}%, 0, 0)`}})}));const th=b(I1)`
  position: relative;
  overflow: hidden;
...
`;c.forwardRef((e,t)=>a.jsx(oh,{ref:t,...e}));const oh=b(V1)`
  display: flex;
  flex-direction: column;
  gap: ${e=>e.theme.spaces[3]};
`;c.forwardRef(({children:e,id:t,...o},r)=>{const n=$e(t);return a.jsxs(A,{gap:2,children:[a.jsx(rh,{id:n,ref:r,...o,children:a.jsx(ah,{})}),a.jsx(B,{tag:"label",htmlFor:n,children:e})]})});const rh=b(E1)`
  background: ${e=>e.theme.colors.neutral0};
  width: 2rem;
  height: 2rem;
  flex: 0 0 2rem;
...
`,sh=e=>{const t=e.querySelector('[tabindex="0"]');t&&t.focus()},tr=c.createContext({rowIndex:0,colIndex:0,setTableValues(){throw new Error("setTableValues must be initialized via the RawTableContext.Provider")}}),ih=()=>c.useContext(tr),ch=c.forwardRef(({colCount:e,rowCount:t,jumpStep:o=3,initialCol:r=0,initialRow:n=0,...s},i)=>{const l=c.useRef(null),d=c.useRef(!1),u=fe(l,i),[h,g]=c.useState(n),[f,x]=c.useState(r),w=c.useCallback(({colIndex:$,rowIndex:v})=>{x($),g(v)},[]);c.useEffect(()=>{d.current&&sh(l.current),d.current||(d.current=!0)},[f,h]);const p=$=>{switch($.key){case de.RIGHT:{$.preventDefault(),x(v=>v<e-1?v+1:v);break}case de.LEFT:{$.preventDefault(),x(v=>v>0?v-1:v);break}case de.UP:{$.preventDefault(),g(v=>v>0?v-1:v);break}case de.DOWN:{$.preventDefault(),g(v=>v<t-1?v+1:v);break}case de.HOME:{$.preventDefault(),$.ctrlKey&&g(0),x(0);break}case de.END:{$.preventDefault(),$.ctrlKey&&g(t-1),x(e-1);break}case de.PAGE_DOWN:{$.preventDefault(),g(v=>v+o<t?v+o:t-1);break}case de.PAGE_UP:{$.preventDefault(),g(v=>v-o>0?v-o:0);break}}},C=c.useMemo(()=>({rowIndex:h,colIndex:f,setTableValues:w}),[f,h,w]);return a.jsx(tr.Provider,{value:C,children:a.jsx("table",{role:"grid",ref:u,"aria-rowcount":t,"aria-colcount":e,onKeyDown:p,...s})})}),Xe=(e,t)=>[...e.querySelectorAll('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])')].filter(n=>!n.hasAttribute("disabled")),Et=e=>e.filter(t=>t.tagName==="INPUT"?t.type!=="checkbox"&&t.type!=="radio":!1),nr=c.forwardRef(({coords:e={col:0,row:0},tag:t="td",...o},r)=>{const n=c.useRef(null),s=fe(r,n),{rowIndex:i,colIndex:l,setTableValues:d}=ih(),[u,h]=c.useState(!1),g=w=>{const p=Xe(n.current);if(p.length===0||p.length===1&&Et(p).length===0)return;if(p.length>1&&!p.find($=>$.tagName!=="BUTTON")){w.preventDefault();const $=p.findIndex(v=>v===document.activeElement);if(w.key===de.RIGHT){const v=p[$+1];v&&(w.stopPropagation(),v.focus())}else if(w.key===de.LEFT){const v=p[$-1];v&&(w.stopPropagation(),v.focus())}return}const C=w.key===de.ENTER;if(C&&!u)h(!0);else if((w.key===de.ESCAPE||C)&&u){if(C&&document.activeElement?.tagName==="A")return;h(!1),n.current.focus()}else u&&w.stopPropagation()},f=i===e.row-1&&l===e.col-1;Ae(()=>{const w=Xe(n.current);w.length===0||w.length===1&&Et(w).length!==0||w.length>1&&w.find(p=>p.tagName!=="BUTTON")?(n.current.setAttribute("tabIndex",!u&&f?"0":"-1"),w.forEach((p,C)=>{p.setAttribute("tabIndex",u?"0":"-1"),u&&C===0&&p.focus()})):w.forEach(p=>{p.setAttribute("tabIndex",f?"0":"-1")})},[u,f]);const x=c.useCallback(()=>{const w=Xe(n.current);w.length>=1&&(Et(w).length!==0||!w.find(p=>p.tagName!=="BUTTON"))&&h(!0),d({rowIndex:e.row-1,colIndex:e.col-1})},[e,d]);return Ae(()=>{const w=n.current;return Xe(w).forEach(C=>{C.addEventListener("focus",x)}),()=>{Xe(w).forEach($=>{$.removeEventListener("focus",x)})}},[x]),a.jsx(I,{role:"gridcell",tag:t,ref:s,onKeyDown:g,...o})}),lh=e=>a.jsx(nr,{...e,tag:"th"}),dh=({children:e,...t})=>{const o=c.Children.toArray(e).map(r=>c.isValidElement(r)?c.cloneElement(r,{"aria-rowindex":1}):r);return a.jsx("thead",{...t,children:o})},hh=({children:e,...t})=>{const o=c.Children.toArray(e).map((r,n)=>c.isValidElement(r)?c.cloneElement(r,{"aria-rowindex":n+2}):r);return a.jsx("tbody",{...t,children:o})},uh=({children:e,...t})=>{const o=c.Children.toArray(e).map((r,n)=>c.isValidElement(r)?c.cloneElement(r,{"aria-colindex":n+1,coords:{col:n+1,row:t["aria-rowindex"]}}):r);return a.jsx(I,{tag:"tr",...t,children:o})},fh=b(qe)`
  font-size: 0.5rem;
  path {
    fill: ${({theme:e})=>e.colors.neutral500};
  }
...
`,wh=({children:e,icon:t,label:o,disabled:r=!1,onClick:n,...s})=>{const i=l=>{r||!n||n(l)};return a.jsxs(A,{inline:!0,background:r?"neutral200":"primary100",color:r?"neutral700":"primary600",paddingLeft:3,paddingRight:1,borderColor:r?"neutral300":"primary200",hasRadius:!0,height:"3.2rem",...s,children:[a.jsx(vh,{$disabled:r,variant:"pi",fontWeight:"bold",children:e}),a.jsx(xh,{tag:"button",disabled:r,"aria-disabled":r,"aria-label":o,padding:2,onClick:i,$iconAction:!!n,children:t})]})},vh=b(B)`
  color: inherit;
  border-right: 1px solid ${({theme:e,$disabled:t})=>t?e.colors.neutral300:e.colors.primary200};
  padding-right: ${({theme:e})=>e.spaces[2]};
`;c.forwardRef(({children:e,clearLabel:t="Clear",customizeContent:o,disabled:r,hasError:n,id:s,name:i,onChange:l,onClear:d,onCloseAutoFocus:u,onReachEnd:h,placeholder:g,required:f,size:x,startIcon:w,value:p,withTags:C,...$},v)=>{const R=c.useRef(null),[y,M]=c.useState(),[j,S]=c.useState(!1),V=_=>{l?l(_):M(_)},z=_=>()=>{const se=Array.isArray(p)?p.filter(ne=>ne!==_):(y??[]).filter(ne=>ne!==_);l?l(se):M(se)},L=_=>{S(_)},q=$e(),D=`intersection-${Fe(q)}`;at(R,_=>{h&&h(_)},{selectorToWatch:`#${D}`,skipWhen:!j});const O=typeof p<"u"&&p!==null?p:y,Y=_=>_&&typeof _=="object"&&_.value?a.jsx(wh,{tabIndex:-1,disabled:r,icon:a.jsx(qe,{width:`${14/16}rem`,height:`${14/16}rem`}),onClick:z(_.value),children:_.textValue},_.value):null,{error:P,...H}=ge("MultiSelect"),N=!!P||n,G=H.id??s,J=H.name??i,Z=H.required??f;let ie;return P?ie=`${G}-error`:H.hint&&(ie=`${G}-hint`),a.jsxs(_o,{onOpenChange:L,disabled:r,required:Z,onValueChange:V,value:O,...$,multi:!0,children:[a.jsx(Fo,{ref:v,id:G,name:J,"aria-label":$["aria-label"],"aria-describedby":ie??$["aria-describedby"],startIcon:w,hasError:N,disabled:r,clearLabel:t,onClear:O?.length?d:void 0,withTags:!!(C&&(O?.length??!1)),size:x,children:a.jsx(Wo,{placeholder:g,textColor:O?.length?"neutral800":"neutral600",children:O?.length?C?Y:o?o(O):void 0:void 0})}),a.jsx(Uo,{children:a.jsx(qo,{position:"popper",sideOffset:4,onCloseAutoFocus:u,children:a.jsxs(Go,{ref:R,children:[e,a.jsx(I,{id:D,width:"100%",height:"1px"})]})})})]})});const ph=c.forwardRef(({value:e,children:t,startIcon:o,...r},n)=>a.jsxs(Ln,{ref:n,value:e.toString(),...r,children:[o&&a.jsx(I,{tag:"span","aria-hidden":!0,children:o}),a.jsx(Ko,{children:({isSelected:s,isIntermediate:i})=>a.jsx(Tn,{checked:i?"indeterminate":s})}),a.jsx(B,{children:a.jsx(Yo,{children:t})})]}));c.forwardRef(({children:e,label:t,startIcon:o,values:r=[],...n},s)=>a.jsxs(e5,{ref:s,children:[a.jsxs(Ln,{value:r,...n,children:[o&&a.jsx(I,{tag:"span","aria-hidden":!0,children:o}),a.jsx(Ko,{children:({isSelected:i,isIntermediate:l})=>a.jsx(Tn,{checked:l?"indeterminate":i})}),a.jsx(B,{children:t})]}),e]}));b(ph)`
  padding-left: ${({theme:e})=>e.spaces[7]};
`;const bh="23.2rem";c.forwardRef(({...e},t)=>a.jsx($h,{ref:t,...e,tag:"nav"}));const $h=b(I)`
  width: ${bh};
...
`;b(V5)`
  width: 2.4rem;
  background-color: ${({theme:e})=>e.colors.neutral200};
`;he(({active:e,children:t,icon:o=null,withBullet:r=!1,isSubSectionChild:n=!1,...s},i)=>a.jsxs(Ch,{background:"neutral100",paddingLeft:n?9:7,paddingBottom:2,paddingTop:2,ref:i,...s,children:[a.jsxs(A,{children:[o?a.jsx(jh,{children:o}):a.jsx(Kt,{$active:e}),a.jsx(B,{paddingLeft:2,children:t})]}),r&&a.jsx(A,{paddingRight:4,children:a.jsx(Kt,{$active:!0})})]}));const Kt=b.span`
  width: 0.4rem;
  height: 0.4rem;
...
`,[Mh,Hn]=Ge("Tabs");c.forwardRef(({disabled:e=!1,variant:t="regular",hasError:o,...r},n)=>a.jsx(Mh,{disabled:e,hasError:o,variant:t,children:a.jsx(Ah,{ref:n,...r})}));const Ah=b(z1)`
  width: 100%;
  position: relative;
`;c.forwardRef((e,t)=>{const{variant:o}=Hn("List");return a.jsx(Ih,{ref:t,...e,$variant:o})});const Ih=b(B1)`
  display: flex;
  align-items: ${e=>e.$variant==="regular"?"flex-end":"unset"};
  position: relative;
  z-index: 0;
`;c.forwardRef(({children:e,disabled:t,...o},r)=>{const{disabled:n,variant:s,hasError:i}=Hn("Trigger"),l=n===!0||n===o.value||t,d=i===o.value;return a.jsxs(Th,{ref:r,...o,$hasError:d,$variant:s,disabled:l,children:[a.jsx(ar,{fontWeight:"bold",variant:s==="simple"?"sigma":void 0,children:e}),s==="simple"?a.jsx(rr,{}):null]})});const rr=b.span`
  display: block;
  width: 100%;
...
`;c.forwardRef((e,t)=>{const{variant:o}=Hn("Content");return a.jsx(Vh,{$variant:o,ref:t,...e})});const Vh=b(O1)`
...
`,Hh=b(I)`
  overflow-x: auto;
`,vu=c.forwardRef(({footer:e,...t},o)=>{const r=c.useRef(null),[n,s]=c.useState(),i=l=>{const d=l.target.scrollWidth-l.target.clientWidth;if(l.target.scrollLeft===0){s("right");return}if(l.target.scrollLeft===d){s("left");return}l.target.scrollLeft>0&&s("both")};return c.useEffect(()=>{r.current.scrollWidth>r.current.clientWidth&&s("right")},[]),a.jsxs(Eh,{shadow:"tableShadow",hasRadius:!0,background:"neutral0",children:[a.jsx(Dh,{$overflowing:n,position:"relative",children:a.jsx(Hh,{ref:r,onScroll:i,paddingLeft:6,paddingRight:6,children:a.jsx(Lh,{ref:o,...t})})}),e]})}),zh=b(hh)`
  & tr:last-of-type {
    border-bottom: none;
  }
`,pu=({children:e,...t})=>a.jsx(zh,{...t,children:e}),Bh=b(dh)`
  border-bottom: 1px solid ${({theme:e})=>e.colors.neutral150};
`,bu=({children:e,...t})=>a.jsx(Bh,{...t,children:e}),kh=b(uh)`
  border-bottom: 1px solid ${({theme:e})=>e.colors.neutral150};
...
`,Cu=c.forwardRef(({children:e,action:t,...o},r)=>a.jsx(sr,{color:"neutral600",as:lh,ref:r,...o,children:a.jsxs(A,{children:[e,t]})})),ju=c.forwardRef(({children:e,...t},o)=>a.jsx(sr,{color:"neutral800",ref:o,...t,children:e}));b(I)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
